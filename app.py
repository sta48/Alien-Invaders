...
class Invaders(GameApp):
    ...
    def start(self):
        ...
        self._text = GLabel(text="Press 'Shift' to Play",font_size = 60,
                            halign='center', valign='middle', font_name = 'Arcade.ttf',
    ...
    def draw(self):
        ...
        elif self._state in [STATE_NEWWAVE, STATE_ACTIVE]:
    ...
    def _determineState(self):
        ...
        shift = self.input.is_key_down('shift') or self.input.is_key_down('rshift')
        click = curr_keys > 0 and self.lastkeys == 0
        if click and shift:
            if self._state == STATE_INACTIVE:
