...
# Highest y value an alien can have
ATOP = GAME_HEIGHT - ALIEN_CEILING
# Vertical distance between 2 aliens
ADIST = (ALIEN_HEIGHT+ALIEN_V_SEP)
# Horizontal distance between aliens
AINITX = ALIEN_H_SEP+ALIEN_WIDTH
